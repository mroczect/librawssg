...
#[cfg(feature = "tera")]
mod tera_tests {
    use crate::common::{MockMarkdownRenderer, MockTemplateRenderer};
...
fn builder_new_works() {
    let _builder = librawssg::SiteBuilder::new();
}

#[test]
fn builder_load_config_file_not_found() {
    let result = librawssg::SiteBuilder::new().load_config("nonexistent.yaml");
