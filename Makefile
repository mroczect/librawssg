...
CARGO          = cargo
MEMBERS        = librawssg_error librawssg_fs librawssg_config librawssg_handler librawssg_templates librawssg_compiler
PUBLISH_ORDER  = librawssg_error librawssg_fs librawssg_config librawssg_handler librawssg_templates librawssg_compiler

PKG           ?= librawssg_handler
...
help:
	...
	@echo "  make test-pkg PKG=librawssg_core"
...
.PHONY: uninstall
uninstall: 
	$(CARGO) uninstall librawssg || true
...
.PHONY: config
config: PKG=librawssg_config
config: ci-pkg

.PHONY: handler
handler: PKG=librawssg_handler
handler: ci-pkg

.PHONY: templates
templates: PKG=librawssg_templates
templates: ci-pkg

.PHONY: compiler
compiler: PKG=librawssg_compiler
compiler: ci-pkg
